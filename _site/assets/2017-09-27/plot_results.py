...
plt.plot(n,gfortran1, '-^', label='Fortran')
...
percent_faster = np.zeros((4,5))
for i in range(4):
    temp = np.array([gfortran1[i], numpy1[i], numba_single_1[i], numba_par_1[i], matlab1[i]])
    fastest = np.min(temp)
...
plt.plot(n,percent_faster[:,0], '-^', label='Fortran')
...
gfortran2 = np.array([1.2813999999999998E-003,1.1580799999999997E-002, 0.10972190000000001,1.7155212000000000])
...
plt.plot(n,gfortran2, '-^', label='Fortran')
...
percent_faster = np.zeros((4,5))
for i in range(4):
    temp = np.array([gfortran2[i], numpy2[i], numba_single_2[i], numba_par_2[i], matlab2[i]])
    fastest = np.min(temp)
